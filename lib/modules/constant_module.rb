module ConstantModule
  ...
  WORK_EXPERIENCE_INLINE_KEYBOARD = [
    Telegram::Bot::Types::InlineKeyboardButton.new(text: "Etnamed (October 2022 - until now)", callback_data: "Etnamed"),
    Telegram::Bot::Types::InlineKeyboardButton.new(text: "Independent developers team (February 2022 - September 2022)", callback_data: "IDT"),
    Telegram::Bot::Types::InlineKeyboardButton.new(text: "Feniks consulting (August 2018 - April 2022)", callback_data: "Feniks")
  ]
