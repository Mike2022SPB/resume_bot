...
ActiveRecord::Schema.define(version: 2023_05_01_111436) do
  ...
  create_table "telegram_messages", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["telegram_profile_id"], name: "index_telegram_messages_on_telegram_profile_id"
  end
  ...
  create_table "telegram_profiles", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.decimal "capital", default: "1000.0", null: false
  end
