...
if Paragraph.find_by(title: "Summary").nil?
  Paragraph.create(title: "Summary",
    description: "Greetings! I am experienced Ruby on Rails developer, proficient in back-end development using Rails framework. Skilled in working with Ruby and integrating with various APIs.")
  puts "=====Summary have been created====="
end

if Paragraph.find_by(title: "IDT").nil?
  Paragraph.create(title: "IDT",
    description: "Independent developers team (February 2022 - September 2022)\n \n" +
      "Working in a small team related to the development of applications and systems from the beginning to the completion of the project. \n \n" + 
...
if Paragraph.find_by(title: "Etnamed").nil?
  Paragraph.create(title: "Etnamed",
    description: "Etnamed (October 2022 - until now)\n \n" +
    "Work in a startup related to the creation of a mobile application in the field of healthcare.\n \n" + 
      ...
      "6. Using kubesphere for application deployment and gitlab for version management; \n \n" +
      "7. Working with sidekiq workers, and non-relational Redis database.")
  puts "=====Etnamed have been created====="
end

if Paragraph.find_by(title: "Feniks consulting").nil?
  Paragraph.create(title: "Feniks consulting",
    description: "Feniks consulting(August 2018 - April 2022)\n \n" +
      "I worked in law. I started as a paralegal and ended up as the head of a legal branch." + 
...
if Paragraph.find_by(title: "Goodpro").nil?
  Paragraph.create(title: "Goodpro",
    description: "✓Completed Ruby on Rails training course. \n \n" + 
...
if Paragraph.find_by(title: "TOLES").nil?
  Paragraph.create(title: "TOLES",
    description: "✓Completed the TOLES(test of legal english skills) \n \n" + 
      "->Plain English \n \n" + 
      "->Techical English \n \n" +
      "->Legal English \n \n" + 
...
if Paragraph.find_by(title: "Economical").nil?
  Paragraph.create(title: "Economical",
    description: "✓Completed economical and accounting courses \n \n" + 
...
if Paragraph.find_by(title: "SLI").nil?
  Paragraph.create(title: "SLI",
    description: "✓Siberian Law Institute(Bachelor of law) \n \n" + 
      "->Court appearance \n \n" + 
      "->Conflictology \n \n" + 
...
if Paragraph.find_by(title: "Webdesign").nil?
  Paragraph.create(title: "Webdesign",
    description: "Completed the course of web-design \n \n" + 
      "->HTML \n \n" + 
      "->CSS \n \n" + 
      "->Javascript \n \n" + 
      "->PHP")
...
# puts "Profiles have been created======="
...
#     number = rand 101..999
#     chat = Chat.create!(
#       title: "Title #{rand 256..512}"
#     )

#     puts "Chat title: #{chat.title}"
#   end
# end

# if UserChat.any? == false
#   15.times do
#     chat_id = rand Chat.first.id..Chat.last.id
#     profile_id = rand Profile.first.id..Profile.last.id
#     UserChat.create!(
#       chat_id: chat_id,
